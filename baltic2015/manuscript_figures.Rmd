...
goal_order <- c("AO", "BD", "CS", "CON", "EUT", "TRA", "CW", "LIV", "ECO", "LE", "FIS", "MAR", "FP", "NP", "LSP", "ICO", "SP", "TR", "Index")
...
## Arrow plot
This is probably a better way of visualizing the information we want
