...
# 1  Poland     21 PL631          PL
# 2  Poland     21 PL634          PL
## but only PL634 was included in the GDP data and was assigned BHI_ID of 17 & 18 incorrectly

correct_assign_PL = correct_assign %>% 
  mutate(correct_BHI_ID = ifelse(nuts3 == 'PL634', '21', correct_BHI_ID))
...
```{r updated NUTS shape file explore}
...
rowcheck(correct_assign_simple, nuts3_updated) 
## all TRUE
