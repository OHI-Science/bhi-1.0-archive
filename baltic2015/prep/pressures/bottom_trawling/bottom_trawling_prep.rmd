...
data_2013 = read_csv(file.path(dir_trawl, 'temp_data', 'trawling_bhi_intersect_2013.csv'))

hours_per_area = data_2013 %>%
...
write_csv(hours_per_area, file.path(dir_trawl, 'temp_data', 'hours_per_area_2013.csv'))
