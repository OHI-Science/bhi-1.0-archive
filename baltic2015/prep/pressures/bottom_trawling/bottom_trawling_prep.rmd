...
Layers are yearly effort.  Years 2009-2013
...
## read in bottom trawling pressure data from 2009
...
plot(trawling_raw_2009)
# head(trawling_raw_2009@data)

#         c_square year mid_lat mid_lon Reported fishing_ho
# 0    Russian EEZ    0   0.000   0.000       No   0.000000
# 1 1500:249:248:4 2009  54.475   9.875      Yes   0.638889
# 2 1500:249:249:3 2009  54.475   9.925      Yes  12.844444


##  extract crs_trawling for scaling 

# trawling_raw_2009@proj4string
...
```{r intersect trawling with BHI shapefiles}
...
## plot trawling efforts 2009 with BHI boundaries
plot(bhi, col = 'light blue', border = "grey", main = "BHI regions and Trawling Efforts intersect"); plot(trawling_raw_2009, col = 'blue', border = "blue", add = TRUE); legend('bottomright', c("BHI regions", "BHI borders", "Trawling efforts (2009)"), lty = c(1,1), lwd = c(2.5, 2.5, 2.5), col = c( "light blue", "grey", "blue"), text.font = 1, box.lty = 0 )

## intersect trawling efforts with bhi shapefile
system.time({trawling_bhi_2009 <- raster::intersect(trawling_raw_2009, bhi)})
plot(trawling_bhi_2009)

# save into bottom_trawling/temp_data folder
write_csv(trawling_bhi_2009@data, file.path(dir_trawl, "temp_data", "trawling_2009.csv"))
