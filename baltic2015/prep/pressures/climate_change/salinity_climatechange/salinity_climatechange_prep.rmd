...
# TO DO... need data fixed then can update this code
## Need to decide which projection to use
...
### 4.5 Minimum val
From projection data, extract the minimum annual surface salinity for each basin between 2020-2050. Compare between the two projection data sets.  The direction of the difference between basins differs - they are within |0.5| of one another. 
```{r min surface sal}
...
ggplot(proj_diff)+
 ...
 theme(axis.text.x = element_text(colour="grey20", size=8, angle=90, 
                                    hjust=.5, vjust=.5, face = "plain"))+
  ggtitle("Difference in Min Val between Projection datasets (ECHAM5 - HADCM3")
...
### 5.5 Minimum val
From projection data, extract the minimum annual deep salinity for each basin between 2020-2050. Compare the two projections
```{r min deep sal}
