...
basin_lookup = read.csv(file.path(dir_nutprep, 'baltic_rgns_to_bhi_rgns_lookup_holas_load_basins.csv'))
basin_lookup = basin_lookup %>% 
               select(rgn_id, cntry_name, basin_name_holas,basin_name_loads)%>%
