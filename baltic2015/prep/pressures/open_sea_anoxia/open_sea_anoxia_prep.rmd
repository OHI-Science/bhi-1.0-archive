...
for (anox_file in anox_file_list) {
  ...
  bal_proj = bathymetry@crs
  bal_res = res(bathymetry)

  t <- raster::rasterFromXYZ( anox, res = bal_res, crs = bal_proj ) 
  # class(t) 
  # plot(t)
  
  dir_temp = make_path('baltic2015/prep/pressures/open_sea_anoxia')
  O2_bottom = raster(t, layer = 'O2_bottom')
  writeRaster(O2_bottom, file.path(dir_temp, file_path_sans_ext(anox_file)))
  # plot(O2_bottom)
