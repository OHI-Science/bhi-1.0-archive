...
``` {r read in bathymetry data, echo = FALSE, message = FALSE}
...
``` {r read in anoxia data, echo = FALSE, message = FALSE}
...
```{r anoxia rescaling, echo = FALSE, message = FALSE }
...
``` {r Max value, echo = FALSE, message = FALSE,  }
...
``` {r Min value, echo = FALSE, message = FALSE,  }
...
``` {r Combine value, echo = FALSE, message = FALSE,  }
