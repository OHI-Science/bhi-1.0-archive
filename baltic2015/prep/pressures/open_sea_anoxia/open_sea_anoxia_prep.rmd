...
for (anox_file in anox_file_list) {
  ...
  #  dplyr::select(longitude, latitude, O2_bottom)
  # head(anox) 
  
  bal_proj = crs("+proj=laea +lat_0=52 +lon_0=10 +x_0=4321000 +y_0=3210000 +ellps=GRS80 +units=m +no_defs")

  t <- raster::rasterFromXYZ( anox, crs = bal_proj ) 
  # class(t)
  # plot(t)
