...
nut_all_years <- full_join(chem_status_bhi_region, secchi_status_bhi_region, by = c('year', 'BHI_ID')) %>% 
  full_join(oxygen_status_bhi_region, by = c('year', 'BHI_ID'))
...
## save as data layers in layers folder 
