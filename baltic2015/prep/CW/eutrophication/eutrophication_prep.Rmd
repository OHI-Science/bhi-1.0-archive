...
* Download notes: datatype: Physical and Chemical; Parameter: secchi depth  
...
## Write csv files to layers
    # readr::write_csv(basin_status,
    #              file.path(dir_layers, "cw_eut_status_score_bhi2015.csv"))
    # 
    # readr::write_csv(bhi_trend,
    #              file.path(dir_layers, "cw_eut_trend_score_bhi2015.csv"))
