...
# 11. BSEP eutrophication data exploration (Final method of eut calcualtion)
...
write_csv(eut_status, file.path(dir_layers, 'cw_eut_status_score_bhi2015'))
write_csv(eut_trend_new, file.path(dir_layers, 'cw_eut_trend_score_bhi2015'))
