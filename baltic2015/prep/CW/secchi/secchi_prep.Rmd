...
**Sampling frequency**
__Can these data decisions be implemented?__
...
secchi_target = full_join(mean_months_summer,target, by=c("basin_name" = "basin"))%>%
...
**Files to save**  
1. Status by BHI region based on basin level calculations
