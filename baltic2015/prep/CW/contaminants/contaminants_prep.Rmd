...
The following document detailed how this subgoal was prepared. However, experts are discussing whether to exclude or modify this goal as it is difficult to represent with just a few indicators. As for now, we will leave Contaminants scores as NA's. 

```{r NA place holder, eval = FALSE}
