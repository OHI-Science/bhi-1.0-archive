...
baltic_layer = eur_rus %>%
  ...
  mutate(ref_point_min = as.numeric(ref_point_min),
         ref_point_max = as.numeric(ref_point_max$modeled_waste_2010),
         trash_score   = (
           (modeled_waste_2010 - ref_point_min) /
           (ref_point_max - ref_point_min))); baltic_layer; summary(baltic_layer)
