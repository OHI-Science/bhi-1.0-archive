...
# mar_basin_id = read.csv("C:/Users/jgrif/Documents/github/bhi/baltic2015/prep/1.2_MAR/mar_basin_id_bhi2015.csv",
#                            header=TRUE) #basin id to have ref pt by basin - have to decide if keep
...
#don't use, data missing for 2 regions, time series look weird
...
#####----------------------######
# Calculate the status for each year (year_value / ref_value)
