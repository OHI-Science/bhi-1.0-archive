---
title: "Natual Products (NP) Goal & Food Provision (FP) - Fisheries (FIS) subgoal Data Prep"
output:
  github_document:
    toc: true
    toc_depth: 3
...
**Fisheries** subgoal of Food Provision describes a country's ability to maximize the sustainable yield of _wild-caught seafood for human consumption_, while **Natural Products** focuses on _non-food_ natural products. 
