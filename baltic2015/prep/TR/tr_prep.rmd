...
## 7. Status Calculation - Alternative 2
...
blue_tr_status <- blue_data %>% 
  mutate(ref_point = total_employ * 1.05, 
...
tr_status <- full_join(bhi_lookup, blue_tr_status, by = "country") %>% 
  select(rgn_id, score)

### rgn 19, 22, 33 don't have scores because there was no data for Russia

# save as data layer
write_csv(tr_status, file.path(dir_layers, "tr_status_scores_bhi2015.csv"))
