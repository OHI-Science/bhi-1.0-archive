...
## Intersect BHI and HELCOM_MAP polygons
...
# mpa_bhi <- raster::intersect(mpa, bhi, progress = "text") # didn't finish processing. took too long. May be becasue file size too large. bhi ~ 45.5 Mb, mpa ~ 8.7 Mb. 
mpa_bhi <- rgeos::gIntersection(mpa, bhi) # worked but lost dataframe. need to reattach data frame in order to calculate area. a lot of trouble. try intersect again. 
plot(mpa_bhi)
