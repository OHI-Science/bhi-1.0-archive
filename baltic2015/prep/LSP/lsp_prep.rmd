...
mgmt_status = read_csv(file.path(dir_prep, 'mpa_data_database/MPA_management_plans_20160415.csv')) %>%
...
## Note: some MPAs from MPA shape file have no match in the management status data file (see in LSP prep folder: mpa_management_with_NA.csv). 
## For those MPAs, management status from the shape file (designated or managed) were used to fill in the blanks. So there are four types 
## of management status (Designated, Managed, In development, and Implemented). 
...
mgmt_weight = data.frame( mgmt_status = c("Designated", "Managed", "In development", "Implemented"),
                          weight = c(0.3, 0.6, 0.6, 1) )
