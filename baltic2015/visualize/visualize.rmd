...
# pdf_dir = c("/Users/jstewart/Dropbox/Baltic Health Index/Visualize")
pdf_dir = c("/Users/ningningj/Dropbox/Baltic Health Index/Visualize")
...
#time_data
time_data_bbmsy = read.csv(file.path(dir_baltic, 'visualize/np_bbmsy_time_data.csv'), stringsAsFactors=FALSE)

time_data_ffmsy = read.csv(file.path(dir_baltic, 'visualize/np_ffmsy_time_data.csv'), stringsAsFactors=FALSE)
  
time_data_landings = read.csv(file.path(dir_baltic, 'visualize/np_landings_time_data.csv'), stringsAsFactors=FALSE)
...
## LSP
```{r LSP goal, eval=FALSE, echo=FALSE}
...
##plot raw spatial; lifted from https://github.com/OHI-Science/bhi/blob/draft/baltic2015/prep/LSP/lsp_prep.md#43-intersect-bhi-and-helcom_mpa-polygons
